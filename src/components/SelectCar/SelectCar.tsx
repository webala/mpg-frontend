...
import { Car, GlobalState, UserCars } from "../../interface";
...
function SelectCar({ cars }: SelectCarProps) {
   ...
   if (!isAuth) {
      return (
         <div className="select-car ">
            <p>
               Please login to select your vehicle. This will help us find the
               right parts for you.
            </p>
         </div>
      );
   ...
   useEffect(() => {
      if (isSuccess) {
         const cars: UserCars[] = vehicles.map((car: Car) => ({
            carId: car.id,
            isSelected: false,
         }));
               ...
               <div>
                  ...
                  {selectionComplete ? (
                     <div className="submit">
                        <button onClick={handleSubmitCar}>
                           Select this car
                        </button>
                     </div>
                  ) : null}
